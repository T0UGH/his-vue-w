<template>
  <AppHeaderDropdown right no-caret>
    <template slot="header">
        <label>{{curr_user.user_name}}</label>
      <img
    ...
    <template slot="dropdown">
      ...
      <b-dropdown-item><i class="fa fa-bell-o" /> 姓名
        <b-badge variant="info">{{curr_user.user_name}}</b-badge>
      </b-dropdown-item>
      <b-dropdown-item><i class="fa fa-user" /> 科室
        <b-badge variant="info">{{curr_dept}}</b-badge>
      </b-dropdown-item>

      <b-dropdown-item><i class="fa fa-user" /> 角色
        <b-badge variant="info">{{curr_role}}</b-badge>
      </b-dropdown-item>
